...
class Conjunto
{
    ...
    private:
        ...
        struct Nodo
        {
            ...
            Nodo(const T& v):izq(nullptr),der(nullptr),valor(v){}
        ...
        Nodo* obtenerPredecesor(Nodo* e);
        Nodo* obtenerSucesor(Nodo* e);

        void destruirNodos(Nodo *pNodo);
        void corregirMayoryMenor(const T& eliminado);
};
