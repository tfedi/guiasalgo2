...
private:
    ...
    struct Nodo {
        ...
        Nodo* siguiente;
        T valor;
        Nodo(Nodo* anterior, Nodo* siguiente, T valor):anterior(anterior),siguiente(siguiente),valor(valor){}
    };
    ...
    /**
     * Copia todos los nodos de la lista o en la lista actual.
     */
    void copiarNodos(const Lista &o);
    /**
     * Elimina todos los nodos de la lista actual.
     */
    void destruirNodos();
